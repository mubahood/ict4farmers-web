...
class MyWorkersController extends AdminController
{
    ...
    protected function form()
    {
        ...
        if ($group_id < 1) {
            return admin_error(
                "Association group not set.",
                'You have not set your Association group yet. Go to your account/profile and select 
            the association that you belong to first, in order to add manage your workers using this system.
            <a href="' . admin_url('auth/setting#tab-form-2') . '">Click here to edit your profile</a>
            '
            );
        }
