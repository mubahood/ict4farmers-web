            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    ...
                    <div class="row">
                        <div class="col-6  ">
                            <a href="javascript:;">
                                <img class="img-fluid" src="{{ url('assets/images/download-apple.png') }}"
                                    alt="">
                            </a>
                        </div>
                        <div class="col-6  ">
...
<div
    class="container border-top border-primary pt-5 mt-5 d-flex flex-column flex-md-row align-items-center justify-content-between bg-white">
